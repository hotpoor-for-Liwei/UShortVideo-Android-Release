...
public enum EffectEnum {
    ...
    Effect_music_filter_1("douyin_02", R.drawable.douyin, "musicfilter/music_filter_1.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_2("douyin_02", R.drawable.douyin, "musicfilter/music_filter_2.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_3("douyin_02", R.drawable.douyin, "musicfilter/music_filter_3.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_4("douyin_02", R.drawable.douyin, "musicfilter/music_filter_4.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_5("douyin_02", R.drawable.douyin, "musicfilter/music_filter_5.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_6("douyin_02", R.drawable.douyin, "musicfilter/music_filter_6.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
    Effect_music_filter_7("douyin_02", R.drawable.douyin, "musicfilter/music_filter_7.bundle", 4, Effect.EFFECT_TYPE_MUSIC_FILTER, 0),
