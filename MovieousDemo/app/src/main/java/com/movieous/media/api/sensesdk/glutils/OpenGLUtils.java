package com.movieous.media.api.sensesdk.glutils;
...
public class OpenGLUtils {
	...
	public static int initEffectTexture(int width, int height,int[] textureId)
	{
	...
	public static void updateBuffer(int target, ByteBuffer previewData, int width, int height) {
